...
export const generateMockBooks = (): Book[] => [
  ...
  // NEW BOOKS - Adding 10 more books
  {
    id: '27',
    ...
    genre: 'Programming',
    description: 'The comprehensive guide to JavaScript programming for both beginners and experienced developers.',
    isbn: '978-1491952023',
    publicationYear: 2020,
    available: true,
    totalCopies: 14,
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3',
    genre: 'Dystopian Fiction',
    description: 'A dystopian novel set in a totalitarian society where women have lost all their rights.',
    isbn: '978-0385490818',
  ...
  },
  {
    ...
    description: 'A coming-of-age mystery about a young woman abandoned by her family in the marshlands of North Carolina.',
    isbn: '978-0735219090',
    publicationYear: 2018,
    available: true,
    totalCopies: 20,
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3',
    genre: 'Biography',
    description: 'The intimate memoir of the former First Lady of the United States, chronicling her journey from childhood to the White House.',
    isbn: '978-1524763138',
    publicationYear: 2018,
    available: true,
    totalCopies: 18,
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1649972904349-6e44c42644a7?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3',
    genre: 'Programming',
    description: 'Building web applications with React, the popular JavaScript library for user interfaces.',
    isbn: '978-1491931820',
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1512820790803-83ca734da794?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3',
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3',
  ...
  },
  {
    ...
    author: 'Eric Matthes',
    coverImage: 'https://images.unsplash.com/photo-1515879218367-8466d910aaa4?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3',
    genre: 'Programming',
